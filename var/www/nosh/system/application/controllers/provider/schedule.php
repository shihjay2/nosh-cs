...
class Schedule extends Application
{
	...
	function index()
	{
		...
		$this->auth->view('provider/schedule', $data);
	}
	...
	function schedule_view()
	{
		...
		$this->load->view('auth/pages/provider/provider_schedule1', $data);
	}
	
	function exceptions()
	{
		$this->load->view('auth/pages/provider/provider_exceptions');
	}
...
/* Location: application/controllers/provider/schedule.php */
