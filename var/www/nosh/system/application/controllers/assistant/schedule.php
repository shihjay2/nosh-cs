...
class Schedule extends Application
{
	...
	function index()
	{
		...
		$this->auth->view('assistant/schedule', $data);
	}
	...
	function schedule_view()
	{
		...
		$this->load->view('auth/pages/assistant/provider_schedule1', $data);
	}
	
	function exceptions()
	{
		$this->load->view('auth/pages/assistant/provider_exceptions');
	}
...
/* Location: application/controllers/assistant/schedule.php */
