<div id="issues_list_dialog" title="Issues">
	...
	<div id="rcopia_update_issues_header" style="display:none">
		<button type="button" id="rcopia_update_issues">Update from RCopia</button>
		<hr class="ui-state-default"/>
	</div>
...
<script type="text/javascript">
	$("#issues_list_dialog").dialog({ 
		...
		open: function(event,ui) {
			...
			jQuery("#issues").jqGrid({
				url:"<?php echo site_url('assistant/chartmenu/issues/');?>",
				datatype: "json",
				mtype: "POST",
			...
			jQuery("#issues_inactive").jqGrid({
				url:"<?php echo site_url('assistant/chartmenu/issues_inactive/');?>",
				datatype: "json",
				mtype: "POST",
				colNames:['ID','Date Active','Issue'],
				colModel:[
	...
	$("#inactivate_issue").click(function(){
		...
		if(item){
			$.ajax({
				type: "POST",
				url: "<?php echo site_url('assistant/chartmenu/inactivate_issue');?>",
				data: "issue_id=" + item,
				success: function(data){
					if (data == 'Close Chart') {
	...
	$("#delete_issue").click(function(){
		...
		if(item){
			if(confirm('Are you sure you want to delete this issue?')){
				$.ajax({
					type: "POST",
					url: "<?php echo site_url('assistant/chartmenu/delete_issue');?>",
					data: "issue_id=" + item,
					success: function(data){
						if (data == 'Close Chart') {
							window.location = "<?php echo site_url();?>";
	...
	$("#reactivate_issue").click(function(){
		...
		if(item){
			$.ajax({
				type: "POST",
				url: "<?php echo site_url('assistant/chartmenu/reactivate_issue');?>",
				data: "issue_id=" + item,
				success: function(data){
					if (data == 'Close Chart') {
						window.location = "<?php echo site_url();?>";
	...
	$("#save_issue").click(function(){
		...
		if (bValid) {
			...
			if(str){
				$.ajax({
					type: "POST",
					url: "<?php echo site_url('assistant/chartmenu/edit_issue');?>",
					data: str,
					success: function(data){
						if (data == 'Close Chart') {
							window.location = "<?php echo site_url();?>";
	...
	$("#copy_oh_pmh_all_issues").click(function(){
		$.ajax({
			type: "POST",
			url: "<?php echo site_url('assistant/encounters/copy_issues');?>",
			success: function(data){
				if (data == 'No') {
