<form id="assessment_form">
	Choose diagnoses from <input type="button" id="assessment_issues" value="Issues Helper" class="ui-button ui-state-default ui-corner-all"> or <input type="text" name="assessment_icd_search" id="assessment_icd_search" size="50" class="text ui-widget-content ui-corner-all" placeholder="Search from ICD9 database."/>
	<div id="assessment_buttons">
		<button type="button" id="assessment_select_icd_1">#1</button>
		<button type="button" id="assessment_select_icd_2">#2</button>
		<button type="button" id="assessment_select_icd_3">#3</button>
		<button type="button" id="assessment_select_icd_4">#4</button>
		<button type="button" id="assessment_select_icd_5">#5</button>
		<button type="button" id="assessment_select_icd_6">#6</button>
		<button type="button" id="assessment_select_icd_7">#7</button>
		<button type="button" id="assessment_select_icd_8">#8</button>
	...
	<div id="assessment_icd1_div_button" style="display:none"><div id="assessment_icd1_div"></div> <button type="button" id="clear_icd1">Clear</button><br></div>
	<div id="assessment_icd2_div_button" style="display:none"><div id="assessment_icd2_div"></div> <button type="button" id="clear_icd2">Clear</button><br></div>
	<div id="assessment_icd3_div_button" style="display:none"><div id="assessment_icd3_div"></div> <button type="button" id="clear_icd3">Clear</button><br></div>
	<div id="assessment_icd4_div_button" style="display:none"><div id="assessment_icd4_div"></div> <button type="button" id="clear_icd4">Clear</button><br></div>
	<div id="assessment_icd5_div_button" style="display:none"><div id="assessment_icd5_div"></div> <button type="button" id="clear_icd5">Clear</button><br></div>
	<div id="assessment_icd6_div_button" style="display:none"><div id="assessment_icd6_div"></div> <button type="button" id="clear_icd6">Clear</button><br></div>
	<div id="assessment_icd7_div_button" style="display:none"><div id="assessment_icd7_div"></div> <button type="button" id="clear_icd7">Clear</button><br></div>
	<div id="assessment_icd8_div_button" style="display:none"><div id="assessment_icd8_div"></div> <button type="button" id="clear_icd8">Clear</button><br></div><br>
	<table>
		<tr>
			<td valign="top">Additional diagnoses:<br><input type="button" id="assessment_other_reset" value="Clear" class="ui-button ui-state-default ui-corner-all"></td>
		...
		<tr>
			<td valign="top">Differential diagnoses:<br><input type="button" id="assessment_ddx_reset" value="Clear" class="ui-button ui-state-default ui-corner-all"></td>
		...
		<tr>
			<td valign="top">Assessment discussion:<br><input type="button" id="assessment_notes_reset" value="Clear" class="ui-button ui-state-default ui-corner-all"></td>
