	...
	$("#mtm_dialog").dialog({ 
		...
		open: function(event, ui) {
			...
			jQuery("#mtm_table").jqGrid({
				url:"<?php echo site_url('provider/chartmenu/mtm/');?>",
				editurl:"<?php echo site_url('provider/chartmenu/edit_mtm');?>",
				datatype: "json",
				mtype: "POST",
							...
							dataInit:function(elem){ 
								...
								$(elem).autocomplete({
									source: function (req, add){
										$.ajax({
											url: "<?php echo site_url('provider/chartmenu/search_issues');?>",
											dataType: "json",
											type: "POST",
		...
		buttons: [{
			...
			click: function() {
				$.ajax({
					type: "POST",
					url: "<?php echo site_url('provider/chartmenu/print_mtm');?>",
					dataType: 'json',
					async: false,
					success: function(data){
						if (data.message == 'OK') {
			...
			click: function() {
				...
				if (success_doc == true) {
					$.ajax({
						type: "POST",
						url: "<?php echo site_url('provider/chartmenu/view_documents1');?>/" + id_doc,
						dataType: "json",
						success: function(data){
			...
			click: function() {
				$.ajax({
					type: "POST",
					url: "<?php echo site_url('provider/chartmenu/print_mtm_provider/print');?>",
					dataType: 'json',
					async: false,
					success: function(data){
						if (data.message == 'OK') {
			...
			click: function() {
				...
				if (a == "encounter") {
					$.ajax({
						type: "POST",
						url: "<?php echo site_url('provider/chartmenu/encounter_mtm');?>",
						dataType: 'json',
						success: function(data){
			...
			'Send Fax': function() {
				...
				if (bValid) {
					...
					if(str){
						$.ajax({
							type: "POST",
							url: "<?php echo site_url('provider/chartmenu/print_mtm_provider/fax');?>/",
							data: str,
							dataType: "json",
							success: function(data){
								$.jGrowl(data.message);
