...
<script type="text/javascript">
	...
	jQuery("#vitals_list").jqGrid({
		url:"<?php echo site_url('assistant/encounters/vitals_list/');?>",
		datatype: "json",
		mtype: "POST",
	...
	$("#weight_chart").click(function(){
		...
		$.ajax({
			type: "POST",
			url: "<?php echo site_url('assistant/growth_chart/index/weight-age');?>/",
			dataType: "json",
	...
	$("#height_chart").click(function(){
		...
		$.ajax({
			type: "POST",
			url: "<?php echo site_url('assistant/growth_chart/index/height-age');?>/",
			dataType: "json",
			success: function(data){
				options.title.text = data.title;
				options.xAxis.title.text = data.xaxis;
	...
	$("#hc_chart").click(function(){
		...
		$.ajax({
			type: "POST",
			url: "<?php echo site_url('assistant/growth_chart/index/head-age');?>/",
			dataType: "json",
			success: function(data){
				options.title.text = data.title;
				options.xAxis.title.text = data.xaxis;
	...
	$("#bmi_chart").click(function(){
		...
		$.ajax({
			type: "POST",
			url: "<?php echo site_url('assistant/growth_chart/index/bmi-age');?>/",
			dataType: "json",
			success: function(data){
				options.title.text = data.title;
				options.xAxis.title.text = data.xaxis;
	...
	$("#weight_height_chart").click(function(){
		...
		$.ajax({
			type: "POST",
			url: "<?php echo site_url('assistant/growth_chart/index/weight-height');?>/",
			dataType: "json",
			success: function(data){
				options.title.text = data.title;
				options.xAxis.title.text = data.xaxis;
	...
	$.ajax({
		type: "POST",
		url: "<?php echo site_url('assistant/encounters/get_vitals');?>",
		dataType: "json",
		success: function(data){
			if (data == '') {
