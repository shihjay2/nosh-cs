<div id="messages_rx_dialog" title="Prescribing Medications Helper">
	<div id="messages_rx_main">
		...
		<input type="button" id="messages_delete_rx" value="Delete Medication" class="ui-button ui-state-default ui-corner-all"/><br><br>
...
<script type="text/javascript">
		...
		buttons: {
			"Prescribe": function() {
				...
				if(str){
					$.ajax({
						type: "POST",
						url: "<?php echo site_url('assistant/chartmenu/prescribe_medication');?>",
						data: str,
						dataType: "json",
						success: function(data){
	...
	$('#save_orders_rx').click(function(){
		...
		$.ajax({
			type: "POST",
			url: "<?php echo site_url('assistant/encounters/orders_rx_save');?>",
				...
				if (data == 'Close Chart') {
					...
					$.ajax({
						...
						success: function(data){
							...
							$.ajax({
								type: "POST",
								url: "<?php echo site_url('assistant/encounters/tip_orders/rx');?>",
								success: function(data){
	...
	$("#messages_eie_rx").click(function(){
		...
		if(item){
			$.ajax({
				type: "POST",
				url: "<?php echo site_url('assistant/chartmenu/eie_medication');?>",
				data: "rxl_id=" + item,
				dataType: 'json',
				success: function(data){
					$.jGrowl(data.message);
	...
	$("#messages_prescribe_medication").click(function(){
		...
		if (bValid) {
			...
			if(str){
				$.ajax({
					type: "POST",
					url: "<?php echo site_url('assistant/chartmenu/interactions_medication');?>",
					data: str,
					dataType: "json",
					success: function(data){
						if (data.message == 'Close Chart') {
	...
	$("#messages_print_medication").click(function(){
		...
		if (bValid) {
			...
			window.open("<?php echo site_url('assistant/chartmenu/print_medication');?>/" + prescribe_id);
			$('#messages_action_rx_form').clearForm();
			$('#messages_action_rx_form').hide('fast');
		}
	});
	$("#messages_eprescribe_medication").click(function(){
		...
		if (bValid) {
			...
			if(str){
				$.ajax({
					type: "POST",
					url: "<?php echo site_url('assistant/chartmenu/eprescribe_medication');?>",
					data: str,
					success: function(data){
						$.jGrowl(data);
						$('#messages_action_rx_form').clearForm();
	...
	$("#messages_fax_medication").click(function(){
		...
		if (bValid) {
			...
			if(str){
				$.ajax({
					type: "POST",
					url: "<?php echo site_url('assistant/chartmenu/start_fax_medication');?>",
					data: str,
					dataType: "json",
					success: function(data){
						$.jGrowl(data.message);
	...
	jQuery("#messages_rx_fax_list").jqGrid({
		url:"<?php echo site_url('assistant/chartmenu/rx_fax_list');?>",
		datatype: "json",
		mtype: "POST",
	...
	$("#messages_rx_fax_viewpage").click(function(){
		...
		if(click_id){
			window.open("<?php echo site_url('assistant/chartmenu/view_faxpage');?>/" + click_id);
		}
	});
	...
	$("#messages_add_fax_contact").click(function(){
		...
		if (bValid) {
			...
			if(str){
				$.ajax({
					type: "POST",
					url: "<?php echo site_url('assistant/chartmenu/add_pharmacy');?>",
					data: str,
					success: function(data){
						$.jGrowl(data);
					}
	...
	$("#messages_send_fax").click(function(){
		...
		if (bValid) {
			...
			if(str){
				$.ajax({
					type: "POST",
					url: "<?php echo site_url('assistant/chartmenu/send_fax_medication');?>",
					data: str,
					success: function(data){
						$.jGrowl(data);
	...
	$("#messages_cancel_fax").click(function(){
		$.ajax({
			type: "POST",
			url: "<?php echo site_url('assistant/chartmenu/cancel_fax_medication');?>",
			success: function(data){
				$.jGrowl(data);
				$('#messages_rx_fax_form').clearForm();
				$('#messages_rx_fax').hide('fast');
