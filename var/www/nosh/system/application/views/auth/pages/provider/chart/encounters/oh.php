...
<div id="oh_sh_dialog" title="Social History">
	...
	<div style="display:block;float:left;">
		...
		<button type="button" id="save_oh_sh_form">Save</button><button type="button" id="cancel_oh_sh_form">Cancel</button><button type="button" id="oh_sh_reset">Clear</button>
		<div id="oh_sh_form">
			...
			<input type="text" name="sh1" id="sh1" style="width:250px" class="text ui-widget-content ui-corner-all"/><br><br>
			Children:<br>
			<input type="text" name="sh2" id="sh2" style="width:250px" class="text ui-widget-content ui-corner-all"/><br><br>
			Pets:<br>
			<input type="text" name="sh3" id="sh3" style="width:250px" class="text ui-widget-content ui-corner-all"/><br><br>
			Diet:<br>
			<input type="text" name="sh4" id="sh4" style="width:250px" class="text ui-widget-content ui-corner-all"/><br><br>
			Exercise:<br>
			<input type="text" name="sh5" id="sh5" style="width:250px" class="text ui-widget-content ui-corner-all"/><br><br>
			Sleep:<br>
			<input type="text" name="sh6" id="sh6" style="width:250px" class="text ui-widget-content ui-corner-all"/><br><br>
			Hobbies:<br>
			<input type="text" name="sh7" id="sh7" style="width:250px" class="text ui-widget-content ui-corner-all"/><br><br>
			<?php echo $childcare;?>
			Sexually Active:<br>
...
<script type="text/javascript">
	$("#copy_oh").button({icons: {primary: "ui-icon-clipboard"}}).click(function(){
		$.ajax({
			type: "POST",
			url: "<?php echo site_url('provider/encounters/copy_oh/oh');?>",
			dataType: "json",
	...
	$.ajax({
		type: "POST",
		url: "<?php echo site_url('provider/encounters/pf_template_select_list/PMH');?>",
		dataType: "json",
		success: function(data){
	...
	$.ajax({
		type: "POST",
		url: "<?php echo site_url('provider/encounters/pf_template_select_list/PSH');?>",
		dataType: "json",
		success: function(data){
	...
	$.ajax({
		type: "POST",
		url: "<?php echo site_url('provider/encounters/pf_template_select_list/FH');?>",
		dataType: "json",
		success: function(data){
	...
	$.ajax({
		type: "POST",
		url: "<?php echo site_url('provider/encounters/pf_template_select_list/SH');?>",
		dataType: "json",
		success: function(data){
	...
	$('.oh_tooltip').tooltip({
		...
		open: function(event, ui) {
			...
			$.ajax({
				type: "POST",
				url: "<?php echo site_url('provider/encounters/tip_oh/');?>/" + id1,
				success: function(data) {
	...
	$("#copy_oh_sh").click(function(){
		$.ajax({
			type: "POST",
			url: "<?php echo site_url('provider/encounters/copy_oh/sh');?>",
			dataType: "json",
			success: function(data){
				if(data.callback == 'Items copied from last encounter!'){
					$.jGrowl(data.callback);
	...
	$("#copy_oh_etoh").click(function(){
		$.ajax({
			type: "POST",
			url: "<?php echo site_url('provider/encounters/copy_oh/etoh');?>",
			dataType: "json",
			success: function(data){
				if(data.callback == 'Items copied from last encounter!'){
					$.jGrowl(data.callback);
	...
	$("#copy_oh_tobacco").click(function(){
		$.ajax({
			type: "POST",
			url: "<?php echo site_url('provider/encounters/copy_oh/tobacco');?>",
			dataType: "json",
			success: function(data){
				if(data.callback == 'Items copied from last encounter!'){
					$.jGrowl(data.callback);
	...
	$("#copy_oh_drugs").click(function(){
		$.ajax({
			type: "POST",
			url: "<?php echo site_url('provider/encounters/copy_oh/drugs');?>",
			dataType: "json",
			success: function(data){
				if(data.callback == 'Items copied from last encounter!'){
					$.jGrowl(data.callback);
	...
	$("#copy_oh_employment").click(function(){
		$.ajax({
			type: "POST",
			url: "<?php echo site_url('provider/encounters/copy_oh/employment');?>",
			dataType: "json",
			success: function(data){
				if(data.callback == 'Items copied from last encounter!'){
					$.jGrowl(data.callback);
