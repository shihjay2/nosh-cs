...
$(document).ready(function() {
		...
		buttons: {
			'Reactivate': function() {
				...
				if (bValid) {
					...
					$.ajax({
						type: "POST",
						url: "<?php echo site_url('provider/office/reactivate_vaccine');?>",
	...
	jQuery("#vaccine_inventory").jqGrid({
		url:"<?php echo site_url('provider/office/vaccine_inventory/');?>",
		datatype: "json",
		mtype: "POST",
	...
	jQuery("#vaccine_inventory_inactive").jqGrid({
		url:"<?php echo site_url('provider/office/vaccine_inventory_inactive/');?>",
		datatype: "json",
		mtype: "POST",
		colNames:['ID','Date Purchased','Expiration Date','Vaccine','Quantity','Lot','Manufacturer','Brand','CVX','CPT'],
		colModel:[
	...
	$("#inactivate_vaccine").click(function(){
		...
		if(item){
			$.ajax({
				type: "POST",
				url: "<?php echo site_url('provider/office/inactivate_vaccine');?>",
	...
	$("#delete_vaccine").click(function(){
		...
		if(item){
			if(confirm('Are you sure you want to delete this vaccination entry?  This is not recommended unless entering the vaccine was a mistake!')){ 
				$.ajax({
					type: "POST",
					url: "<?php echo site_url('provider/office/delete_vaccine');?>",
					data: "vaccine_id=" + item,
					success: function(data){
						$.jGrowl(data);
						jQuery("#vaccine_inventory").trigger("reloadGrid");
	...
	$("#save_vaccine").click(function(){
		...
		if (bValid) {
			...
			if(str){
				$.ajax({
					type: "POST",
					url: "<?php echo site_url('provider/office/edit_vaccine');?>",
					data: str,
					success: function(data){
						$.jGrowl(data);
						jQuery("#vaccine_inventory").trigger("reloadGrid");
	...
	jQuery("#vaccine_temp").jqGrid({
		url:"<?php echo site_url('provider/office/vaccine_temp/');?>",
		datatype: "json",
		mtype: "POST",
	...
	$("#delete_temp").click(function(){
		...
		if(item){
			if(confirm('Are you sure you want to delete this vaccine temperature entry?  This is not recommended unless entering the temperature was a mistake!')){ 
				$.ajax({
					type: "POST",
					url: "<?php echo site_url('provider/office/delete_temp');?>",
					data: "temp_id=" + item,
					success: function(data){
						$.jGrowl(data);
	...
	$("#save_temp").click(function(){
		...
		if (bValid) {
			...
			if(str){
				$.ajax({
					type: "POST",
					url: "<?php echo site_url('provider/office/edit_temp');?>",
					data: str,
					success: function(data){
						$.jGrowl(data);
						jQuery("#vaccine_temp").trigger("reloadGrid");
	...
	jQuery("#supplements_inventory").jqGrid({
		url:"<?php echo site_url('provider/office/supplement_inventory/');?>",
		datatype: "json",
		mtype: "POST",
	...
	jQuery("#supplements_inventory_inactive").jqGrid({
		url:"<?php echo site_url('provider/office/supplement_inventory_inactive/');?>",
		datatype: "json",
		mtype: "POST",
		colNames:['ID','Date Purchased','Expiration Date','Supplement','Strength','Quantity','Manufacturer','Lot','CPT','Charge'],
		colModel:[
	...
	$("#inactivate_supplement").button().click(function(){
		...
		if(item){
			$.ajax({
				type: "POST",
				url: "<?php echo site_url('provider/office/inactivate_supplement');?>",
	...
	$("#delete_supplement").button().click(function(){
		...
		if(item){
			if(confirm('Are you sure you want to delete this supplement entry?  This is not recommended unless entering the supplement was a mistake!')){ 
				$.ajax({
					type: "POST",
					url: "<?php echo site_url('provider/office/delete_supplement');?>",
					data: "supplement_id=" + item,
					success: function(data){
						$.jGrowl(data);
						jQuery("#supplements_inventory").trigger("reloadGrid");
	...
	$("#save_supplement").button().click(function(){
		...
		if (bValid) {
			...
			if(str){
				$.ajax({
					type: "POST",
					url: "<?php echo site_url('provider/office/edit_supplement');?>",
					data: str,
					success: function(data){
						$.jGrowl(data);
						jQuery("#supplements_inventory").trigger("reloadGrid");
		...
		buttons: {
			'Reactivate': function() {
				...
				if (bValid) {
					...
					$.ajax({
						type: "POST",
						url: "<?php echo site_url('provider/office/reactivate_supplement');?>",
	...
	$("#super_query_submit").click(function(){
		...
		jQuery("#super_query_results").jqGrid({
			url:"<?php echo site_url('provider/office/super_query/');?>",
			datatype: "json",
	...
	$.ajax({
		type: "POST",
		url: "<?php echo site_url('provider/office/age_percentage');?>",
		dataType: "json",
		success: function(data){
	...
	$("#export_demographics").button().click(function(){
		window.open("<?php echo site_url('provider/office/export_demographics');?>/all");
	});
