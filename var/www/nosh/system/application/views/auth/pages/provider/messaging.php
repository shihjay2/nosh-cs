...
function gridReload(){ 
	...
	jQuery("#all_contacts_list").setGridParam({url:"<?php echo site_url('provider/messaging/all_contacts');?>/"+mask,page:1}).trigger("reloadGrid");
}
$(document).ready(function() {
	...
	jQuery("#internal_draft").jqGrid({
		url:"<?php echo site_url('provider/messaging/internal_draft/');?>",
		datatype: "json",
		mtype: "POST",
	...
	jQuery("#internal_outbox").jqGrid({
		url:"<?php echo site_url('provider/messaging/internal_outbox/');?>",
		datatype: "json",
		mtype: "POST",
	...
	$("#export_message").click(function(){
		...
		if(pid){
			$.ajax({
				type: "POST",
				url: "<?php echo site_url('provider/messaging/export_message');?>",
	...
	$("#new_fax").click(function(){
		...
		$.ajax({
			type: "POST",
			url: "<?php echo site_url('provider/messaging/new_fax');?>",
			success: function(data){
				$.jGrowl(data);
				...
				jQuery("#send_list").jqGrid({
					url:"<?php echo site_url('provider/messaging/send_list');?>",
					editurl:"<?php echo site_url('provider/messaging/edit_send_list');?>",
					datatype: "json",
					mtype: "POST",
				...
				jQuery("#pages_list").jqGrid({
					url:"<?php echo site_url('provider/messaging/pages_list');?>",
					datatype: "json",
					mtype: "POST",
	...
	jQuery("#received_faxes").jqGrid({
		url:"<?php echo site_url('provider/messaging/receive_fax');?>",
		datatype: "json",
		mtype: "POST",
		...
		sortname: 'fileDateTime',
	 	...
	 	onSelectRow: function(id){
	 		...
	 		if(file){
				...
				var image = "<?php echo site_url('provider/messaging/view_thumbnail');?>/" + thumbnail[0];
	...
	$("#delete").click(function(){
		...
		if(click_id){
			if(confirm('Are you sure you want to delete this fax?')){ 
				...
				$.ajax({
					type: "POST",
					url: "<?php echo site_url('provider/messaging/deletefax');?>",
	...
	$("#savefax").click(function(){
		...
		$("#view_received_id").val(id);
 		$.ajax({
			type: "POST",
			url: "<?php echo site_url('provider/messaging/view_fax1');?>/" + id,
			dataType: "json",
			success: function(data){
	...
	$("#save_fax_import").click(function() {
		...
		if (bValid) {
			...
			if(str){
				$.ajax({
					type: "POST",
					url: "<?php echo site_url('provider/messaging/fax_import');?>",
					data: str,
					success: function(data){
						$.jGrowl(data);
						$('#fax_import_form').clearForm();
	...
	jQuery("#draft_faxes").jqGrid({
		url:"<?php echo site_url('provider/messaging/drafts_list');?>",
		datatype: "json",
		mtype: "POST",
		...
		sortname: 'job_id',
	 	...
	 	onSelectRow: function(id){
	 		$.ajax({
				type: "POST",
				url: "<?php echo site_url('provider/messaging/set_id/');?>",
				data: "job_id=" + id,
				success: function(data){
					$("#img_preview").hide('fast');
					$("#status_preview").hide('fast');
					...
					$.ajax({
						type: "POST",
						url: "<?php echo site_url('provider/messaging/sendfinal');?>",
						dataType: "json",
						success: function(data){
					...
					$.ajax({
						type: "POST",
						url: "<?php echo site_url('provider/messaging/fax_type_check');?>",
						success: function(data){
							if (data == 'nosh') {
	...
	$("#quick_search_contact").autocomplete({
		...
		select: function(event, ui){
			$.ajax({
				type: "POST",
				url: "<?php echo site_url('provider/messaging/add_fax_recipient');?>",
	...
	$("#viewpage").click(function(){
		...
		if(click_id){
			window.open("<?php echo site_url('provider/messaging/view_page');?>/" + click_id);
		}
	});
	...
	$("#send_fax").click(function(){
		var str = $("#sendfinal").serialize();		
			...
			$.ajax({
				type: "POST",
				url: "<?php echo site_url('provider/messaging/form_submit2');?>",
				data: str,
				success: function(data){
					$.jGrowl(data);
					$("#sendfinal").clearForm();
	...
	$('#cancel_fax').click(function(){
		$.ajax({
			type: "POST",
			url: "<?php echo site_url('provider/messaging/cancelfax');?>",
			success: function(data){
				$.jGrowl(data);
				$("#sendfinal").clearForm();
				$("#select_recipients").hide('fast');
	...
	jQuery("#sent_faxes").jqGrid({
		url:"<?php echo site_url('provider/messaging/sent_list');?>",
		datatype: "json",
		mtype: "POST",
	...
	$("#get_scans").click(function(){
		$.ajax({
			type: "POST",
			url: "<?php echo site_url('provider/messaging/get_scans');?>",
			success: function(data){
	...
	jQuery("#received_scans").jqGrid({
		url:"<?php echo site_url('provider/messaging/scans');?>",
		datatype: "json",
		mtype: "POST",
		...
		sortname: 'fileDateTime',
	 	...
	 	onCellSelect: function(id,iCol){
	 		if (iCol > 0) {
		 		...
		 		$.ajax({
					type: "POST",
					url: "<?php echo site_url('provider/messaging/view_scan1');?>/" + id,
					dataType: "json",
					success: function(data){
	...
	$("#save_scan_import").click(function() {
		...
		if (bValid) {
			...
			if(str){
				$.ajax({
					type: "POST",
					url: "<?php echo site_url('provider/messaging/scan_import');?>",
					data: str,
					success: function(data){
						$.jGrowl(data);
						$('#scan_import_form').clearForm();
	...
	$("#savescan1_send").click(function(){
		...
		if(click_id){
			...
			for (var i = 0; i < count; i++) {
				$.ajax({
					type: "POST",
					url: "<?php echo site_url('provider/messaging/scan_import1');?>",
		...
		if(click_id){
			if(confirm('Are you sure you want to delete the seletected documents?')){ 
				...
				for (var i = 0; i < count; i++) {
					$.ajax({
						type: "POST",
						url: "<?php echo site_url('provider/messaging/deletescan');?>",
	...
	$("#messaging_delete_contact").click(function(){
		...
		if(item){
			if(confirm('Are you sure you want to delete this contact?')){
				$.ajax({
					type: "POST",
					url: "<?php echo site_url('provider/messaging/delete_contact');?>",
	...
	$("#messaging_save_contact").click(function(){
		...
		$.ajax({
			type: "POST",
			url: "<?php echo site_url('provider/messaging/edit_contact');?>",
			data: str,
			success: function(data){
				$.jGrowl(data);
				$("#messaging_contact_form").clearForm();
	...
	$("#fax_view_dialog").dialog({ 
		...
		close: function(event, ui) {
			...
			$.ajax({
				type: "POST",
				url: "<?php echo site_url('provider/messaging/close_fax');?>",
				data: "fax_filepath=" + a,
				success: function(data){
					$("#embedURL1").html('');
					$("#fax_filepath").val('');
	...
	$("#save_fax").click(function() {
		...
		window.open("<?php echo site_url('provider/messaging/view_fax');?>/" + id);
	});
	$("#import_fax").button({
		icons: {
			primary: "ui-icon-disk"
	...
	$("#scan_view_dialog").dialog({ 
		...
		close: function(event, ui) {
			...
			$.ajax({
				type: "POST",
				url: "<?php echo site_url('provider/messaging/close_scan');?>",
	...
	$("#save_scan").click(function() {
		...
		window.open("<?php echo site_url('provider/messaging/view_scan');?>/" + id);
	});
	$("#import_scan").button({
		icons: {
			primary: "ui-icon-disk"
			...
			<div id="messaging_provider_tabs">
									...
									<table>
										<tr>
											<td valign="top">
												...
												<div id="addfile_div">
													<form id="addfile_form" action="<?php echo site_url('provider/messaging/pages_upload');?>" method="post" enctype="multipart/form-data">
				...
				<div id="provider_messaging_tabs_4">
					...
					<div id="import_csv_div" style="display:none"> 
						<br>
						<form id="import_csv_form" action="<?php echo site_url('provider/messaging/import_contact');?>" method="post" enctype="multipart/form-data">
