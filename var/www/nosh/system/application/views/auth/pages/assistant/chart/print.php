...
<script type="text/javascript">
	...
	$("#print_list_dialog").dialog({ 
		...
		open: function(event, ui) {
			...
			jQuery("#records_release").jqGrid({
				url:"<?php echo site_url('assistant/chartmenu/records_release/');?>",
				datatype: "json",
				mtype: "POST",
	...
	$("#edit_records_release").click(function() {
		...
		if(item){
			...
			$.ajax({
				type: "POST",
				url: "<?php echo site_url('assistant/chartmenu/get_release_stats');?>",
				data: "hippa_id=" + item,
				success: function(data){
			...
			jQuery("#print_items_queue").jqGrid({
				url:"<?php echo site_url('assistant/chartmenu/print_queue/');?>/" + $("#print_hippa_id").val(),
				datatype: "json",
				mtype: "POST",
	...
	$("#save_print_chart_form").click(function(){
		...
		if (bValid) {
			...
			if(str){
				$.ajax({
					type: "POST",
					url: "<?php echo site_url('assistant/chartmenu/print_chart_save/');?>",
					data: str,
					success: function(data){
						if (data == 'Close Chart') {
	...
	$("#edit_hippa").click(function(){
		...
		$.ajax({
			type: "POST",
			url: "<?php echo site_url('assistant/chartmenu/get_release');?>/" + hippa_id,
			dataType: "json",
			success: function(data){
	...
	$("#print_all").click(function(){
		...
		$.ajax({
			type: "POST",
			url: "<?php echo site_url('assistant/chartmenu/print_chart');?>/" + hippa_id,
			async: false,
			success: function(data){
				if (data == 'OK') {
					success_doc = true;
		...
		if (success_doc == true) {
			window.open("<?php echo site_url('assistant/chartmenu/view_printchart');?>/" + hippa_id);
			success_doc = false;
		}
	});
	$("#fax_all").button({
	...
	$("#ccda_all").click(function(){
		var hippa_id = $("#print_hippa_id").val();
		window.open("<?php echo site_url('assistant/chartmenu/ccda');?>/" + hippa_id + "/all");
	});
	$("#print_1year").button({
		icons: {
			primary: "ui-icon-print"
	...
	$("#print_1year").click(function(){
		...
		$.ajax({
			type: "POST",
			url: "<?php echo site_url('assistant/chartmenu/print_chart2');?>/" + hippa_id,
			async: false,
			success: function(data){
				if (data == 'OK') {
					success_doc = true;
	...
	$("#ccda_1year").click(function(){
		var hippa_id = $("#print_hippa_id").val();
		window.open("<?php echo site_url('assistant/chartmenu/ccda');?>/" + hippa_id + "/1year");
	});
		...
		if (bValid) {
			...
			if(str){
				if (type == 'All') {
					$.ajax({
						type: "POST",
						url: "<?php echo site_url('assistant/chartmenu/fax_chart');?>/" + hippa_id,
						data: str,
						dataType: "json",
						success: function(data){
							$.jGrowl(data.message);
				...
				if (type == '1year') {
					$.ajax({
						type: "POST",
						url: "<?php echo site_url('assistant/chartmenu/fax_chart2');?>/" + hippa_id,
						data: str,
						dataType: "json",
						success: function(data){
							$.jGrowl(data.message);
				...
				if (type == 'Part') {
					$.ajax({
						type: "POST",
						url: "<?php echo site_url('assistant/chartmenu/fax_chart1');?>/" + hippa_id,
						data: str,
						dataType: "json",
						success: function(data){
							$.jGrowl(data.message);
	...
	$("#print_queue").click(function(){
		...
		$.ajax({
			type: "POST",
			url: "<?php echo site_url('assistant/chartmenu/print_chart1');?>/" + hippa_id,
			async: false,
			success: function(data){
				if (data == 'OK') {
					success_doc = true;
	...
	$("#ccda_queue").click(function(){
		var hippa_id = $("#print_hippa_id").val();
		window.open("<?php echo site_url('assistant/chartmenu/ccda');?>/" + hippa_id + "/queue");
	});
	$("#remove_item").button({
		icons: {
			primary: "ui-icon-close"
	...
	$("#remove_item").click(function(){
		...
		if(item){
			$.ajax({
				type: "POST",
				url: "<?php echo site_url('assistant/chartmenu/delete_chart_item');?>",
				data: "hippa_id=" + item,
				success: function(data){
					$.jGrowl(data);
	...
	$("#clear_queue").click(function(){
		...
		if(item){
			$.ajax({
				type: "POST",
				url: "<?php echo site_url('assistant/chartmenu/clear_queue');?>",
	...
	jQuery("#print_encounters").jqGrid({
		url:"<?php echo site_url('assistant/chartmenu/print_encounters/');?>",
		datatype: "json",
		mtype: "POST",
		...
		sortname: 'encounter_DOS',
	 	...
	 	onCellSelect: function(id,iCol) {
	 		if (iCol > 0) {
		 		$.ajax({
					type: "POST",
					url: "<?php echo site_url('assistant/chartmenu/modal_view/');?>/" + id,
					success: function(data){
		...
		onClickButton: function(){ 
			...
			if(id){
 				...
 				for (var i = 0; i < count; i++) {
 					$.ajax({
						type: "POST",
						url: "<?php echo site_url('assistant/chartmenu/add_print_queue1');?>",
	...
	jQuery("#print_messages").jqGrid({
		url:"<?php echo site_url('assistant/chartmenu/print_messages/');?>",
		datatype: "json",
		mtype: "POST",
		...
		onClickButton: function(){ 
			...
			if(id){
 				...
 				for (var i = 0; i < count; i++) {
 					$.ajax({
						type: "POST",
						url: "<?php echo site_url('assistant/chartmenu/add_print_queue2');?>",
		...
		onClickButton: function(){ 
			...
			if(id){
 				...
 				for (var i = 0; i < count; i++) {
 					$.ajax({
						type: "POST",
						url: "<?php echo site_url('assistant/chartmenu/add_print_queue');?>",
