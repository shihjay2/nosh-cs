...
<div id="demographics_list_dialog" title="Demographics" style="font-size: 0.9em">
...
<div id="demographics_insurance_plan_dialog" title="" style="font-size: 0.9em">
...
<div id="menu_insurance_main_dialog" title="Insurance Plan" style="font-size: 0.9em">
...
<div id="demographics_insurance_dialog" title="Insurance" style="font-size: 0.9em">
...
<div id="messages_list_dialog" title="Messages" style="font-size: 0.9em">
...
<div id="messages_main_dialog" title="Message" style="font-size: 0.9em">
...
<div id="messages_telephone_dialog" title="Message Helper" style="font-size: 0.9em">
...
<div id="encounter_view_dialog" title="Encounter" style="font-size: 0.9em">
	<div id="encounter_view"></div>
</div>
<div id="encounter_list_dialog" title="Past Encounters" style="font-size: 0.9em">
...
<div id="imm_load"></div>
<div id="medications_list_dialog" title="Medications" style="font-size: 0.9em" >
...
<div id="allergies_list_dialog" title="Allergies" style="font-size: 0.9em">
...
<div id="alerts_list_dialog" title="Alerts and Tasks" style="font-size: 0.9em">
...
<div id="documents_edit_dialog" title="Edit Documents" style="font-size: 0.9em">
...
<div id="documents_view_dialog" title="Documents Viewer" style="font-size: 0.9em">
...
//Demographics
	$('.menu_tooltip').tooltip({
		...
		open: function(event, ui){
			...
			$.ajax({
				type: "POST",
				url: "<?php echo site_url('assistant/chartmenu/');?>/" + id,
	...
	$.ajax({
		type: "POST",
		url: "<?php echo site_url('assistant/chartmenu/demographics_load');?>",
		dataType: "json",
		success: function(data){
	...
	$("#demographics_insurance_dialog").dialog({ 
		...
		open: function(event, ui) {
			...
			jQuery("#demographics_insurance_inactive").jqGrid({
				url:"<?php echo site_url('assistant/chartmenu/insurance_inactive/');?>",
				datatype: "json",
				mtype: "POST",
		...
		if (a == "Cellular Phone") {
			if (b != "") {
				...
				if(str){
					$.ajax({
						type: "POST",
						url: "<?php echo site_url('assistant/chartmenu/edit_demographics');?>",
						data: str,
						success: function(data){
							if (data == 'Close Chart') {
	...
	$.ajax({
		type: "POST",
		url: "<?php echo site_url('assistant/chartmenu/check_registration_code');?>",
		success: function(data){
			if (data == 'n') {
	...
	$("#register_menu_demographics").button().click(function() {
		$.ajax({
			type: "POST",
			url: "<?php echo site_url('assistant/chartmenu/register_patient');?>",
			success: function(data){
				$("#register_menu_demographics").hide();
				$("#menu_registration_code").html(data);
			}
	...
	$("#demographics_inactivate_insurance").click(function(){
		...
		if(item){
			$.ajax({
				type: "POST",
				url: "<?php echo site_url('assistant/chartmenu/inactivate_insurance');?>",
	...
	$("#demographics_delete_insurance").click(function(){
		...
		if(item){
			if(confirm('Are you sure you want to delete this insurance?  This is not recommended unless entering the insurance was a mistake!')){ 
				$.ajax({
					type: "POST",
					url: "<?php echo site_url('assistant/chartmenu/delete_insurance');?>",
					data: "insurance_id=" + item,
					success: function(data){
						if (data == 'Close Chart') {
							window.location = "<?php echo site_url();?>";
	...
	$("#demographics_reactivate_insurance").click(function(){
		...
		if(item){
			$.ajax({
				type: "POST",
				url: "<?php echo site_url('assistant/chartmenu/reactivate_insurance');?>",
				data: "insurance_id=" + item,
				success: function(data){
					if (data == 'Close Chart') {
						window.location = "<?php echo site_url();?>";
			...
			'Save': function() {
				...
				if (bValid) {
					...
					if(str){
						$.ajax({
							type: "POST",
							url: "<?php echo site_url('assistant/chartmenu/edit_insurance');?>",
							data: str,
							success: function(data){
								if (data == 'Close Chart') {
									window.location = "<?php echo site_url();?>";
			...
			'Save': function() {
				...
				if (bValid) {
					...
					if(str){
						$.ajax({
							type: "POST",
							url: "<?php echo site_url('assistant/chartmenu/edit_insurance_provider');?>",
							data: str,
							dataType: "json",
							success: function(data){
								$.jGrowl(data.message);
	...
	$("#menu_insurance_relationship").change(function(){
		if($("#menu_insurance_relationship").val() == "Self") {
			$.ajax({
				type: "POST",
				url: "<?php echo site_url('assistant/chartmenu/copy_address');?>",
				dataType: "json",
				success: function(data){
	...
	$("#messages_list_dialog").dialog({ 
		...
		open: function(event, ui) {
			...
			jQuery("#messages").jqGrid({
				url:"<?php echo site_url('assistant/chartmenu/messages/');?>",
				datatype: "json",
				mtype: "POST",
	...
	$("#messages_rx_load").load('<?php echo site_url("assistant/chartmenu/rx_load");?>');
	$("#messages_lab_load").load('<?php echo site_url("assistant/chartmenu/lab_load");?>');
	$("#messages_rad_load").load('<?php echo site_url("assistant/chartmenu/rad_load");?>');
	$("#messages_cp_load").load('<?php echo site_url("assistant/chartmenu/cp_load");?>');
	$("#messages_ref_load").load('<?php echo site_url("assistant/chartmenu/ref_load");?>');
	...
	$("#new_telephone_message").click(function() {
		$("#edit_message_form").clearForm();
		$.ajax({
			url: "<?php echo site_url('assistant/chartmenu/new_message');?>",
			dataType: "json",
			type: "POST",
			success: function(data){
	...
	$("#save_message").click(function() {
		...
		if (bValid) {
			...
			if(str){
				$.ajax({
					type: "POST",
					url: "<?php echo site_url('assistant/chartmenu/edit_message');?>",
					data: str,
					success: function(data){
						$.jGrowl(data);
						jQuery("#messages").trigger("reloadGrid");
	...
	$("#sign_message").click(function() {
		...
		if (bValid) {
			...
			if(str){
				$.ajax({
					type: "POST",
					url: "<?php echo site_url('assistant/chartmenu/sign_message');?>",
					data: str,
					success: function(data){
						if(data) {
							$.jGrowl(data);
	...
	$("#delete_message").click(function() {
		...
		if(str != ''){
			$.ajax({
				type: "POST",
				url: "<?php echo site_url('assistant/chartmenu/delete_message');?>",
	...
	$("#encounter_list_dialog").dialog({ 
		...
		open: function (event, ui) {
			jQuery("#encounters").jqGrid({
				url:"<?php echo site_url('assistant/chartmenu/encounters/');?>",
				datatype: "json",
				mtype: "POST",
				...
				sortname: 'encounter_DOS',
			 	...
			 	onSelectRow: function(id) {
			 		...
			 		if (status == "Draft") {
			 			$.ajax({
							type: "POST",
							url: "<?php echo site_url('assistant/chartmenu/encounter_id_set/');?>",
							data: "eid=" + id,
							success: function(data) {
								window.location = "<?php echo site_url ('assistant/encounters/view/');?>";
							}
						});
			 		}
			 		if (status == "Signed") {
			 			$("#encounter_view").load('<?php echo site_url("assistant/encounters/modal_view");?>/' + id);
	...
	//Issues
	$("#issues_load").load('<?php echo site_url("assistant/chartmenu/issues_load");?>');
	...
	$("#medications_list_dialog").dialog({ 
		...
		open: function(event, ui) {
			...
			jQuery("#medications").jqGrid({
				url:"<?php echo site_url('assistant/chartmenu/medications/');?>",
				datatype: "json",
				mtype: "POST",
				...
				sortname: 'rxl_date_active',
			 	...
			 	onSelectRow: function(id){
					...
					$.ajax({
						type: "POST",
						url: "<?php echo site_url('assistant/chartmenu/past_medication');?>",
			...
			jQuery("#medications_inactive").jqGrid({
				url:"<?php echo site_url('assistant/chartmenu/medications_inactive/');?>",
				datatype: "json",
				mtype: "POST",
				...
				colModel:[
					...
					{name:'rxl_date_active',index:'rxl_date_active',width:100,formatter:'date',formatoptions:{srcformat:"ISO8601Long", newformat: "ISO8601Short"}},
					{name:'rxl_due_date',index:'rxl_due_date',width:100,formatter:'date',formatoptions:{srcformat:"ISO8601Long", newformat: "ISO8601Short"}},
					{name:'rxl_medication',index:'rxl_medication',width:355},
					{name:'rxl_dosage',index:'rxl_dosage',width:50},
					{name:'rxl_dosage_unit',index:'rxl_dosage_unit',width:50},
					{name:'rxl_sig',index:'rxl_sig',width:50},
					{name:'rxl_route',index:'rxl_route',width:1,hidden:true},
	...
	$("#rxl_dosage").autocomplete({
		...
		select: function(event, ui){
			...
			$.ajax({
				url: "<?php echo site_url('search/rx_ndc');?>/" + ui.item.ndc,
				type: "POST",
				success: function(data){
					$("#rxl_ndcid").val(data);
				}
	...
	$("#inactivate_rx").click(function(){
		...
		if(item){
			$.ajax({
				type: "POST",
				url: "<?php echo site_url('assistant/chartmenu/inactivate_medication');?>",
				data: "rxl_id=" + item,
				dataType: "json",
				success: function(data){
					$.jGrowl(data.message);
	...
	$("#delete_rx").click(function(){
		...
		if(item){
			if(confirm('Are you sure you want to delete this medication?  This is not recommended unless entering the medication was a mistake!')){ 
				$.ajax({
					type: "POST",
					url: "<?php echo site_url('assistant/chartmenu/delete_medication');?>",
					data: "rxl_id=" + item,
					success: function(data){
						$.jGrowl(data);
						jQuery("#medications").trigger("reloadGrid");
	...
	$("#reactivate_rx").click(function(){
		...
		if(item){
			$.ajax({
				type: "POST",
				url: "<?php echo site_url('assistant/chartmenu/reactivate_medication');?>",
				data: "rxl_id=" + item,
				dataType: "json",
				success: function(data){
					$.jGrowl(data.message);
	...
	$("#save_medication").click(function(){
		...
		if (bValid) {
			...
			if(str){
				$.ajax({
					type: "POST",
					url: "<?php echo site_url('assistant/chartmenu/edit_medication');?>",
					data: str,
					success: function(data){
						if (data == 'Close Chart') {
							window.location = "<?php echo site_url();?>";
	...
	//Supplements
	$("#supplements_load").load('<?php echo site_url("assistant/chartmenu/supplements_load");?>');
	...
	$("#allergies_list_dialog").dialog({ 
		...
		open: function(event, ui) {
			...
			jQuery("#allergies").jqGrid({
				url:"<?php echo site_url('assistant/chartmenu/allergies/');?>",
				datatype: "json",
				mtype: "POST",
			...
			jQuery("#allergies_inactive").jqGrid({
				url:"<?php echo site_url('assistant/chartmenu/allergies_inactive/');?>",
				datatype: "json",
				mtype: "POST",
				colNames:['ID','Date Active','Medication','Reason'],
				colModel:[
	...
	$("#rcopia_update_allergies").button({
		...
		$.ajax({
			type: "POST",
			url: "<?php echo site_url('assistant/chartmenu/rcopia_update_allergy');?>",
			success: function(data){
				if (data == 'Close Chart') {
					window.location = "<?php echo site_url();?>";
				} else {
	...
	$("#inactivate_allergy").click(function(){
		...
		if(item){
			$.ajax({
				type: "POST",
				url: "<?php echo site_url('assistant/chartmenu/inactivate_allergy');?>",
	...
	$("#delete_allergy").click(function(){
		...
		if(item){
			if(confirm('Are you sure you want to delete this allergy?')){
				$.ajax({
					type: "POST",
					url: "<?php echo site_url('assistant/chartmenu/delete_allergy');?>",
					data: "allergies_id=" + item,
					success: function(data){
						$.jGrowl(data);
						jQuery("#allergies").trigger("reloadGrid");
	...
	$("#reactivate_allergy").click(function(){
		...
		if(item){
			$.ajax({
				type: "POST",
				url: "<?php echo site_url('assistant/chartmenu/reactivate_allergy');?>",
				data: "allergies_id=" + item,
				success: function(data){
					$.jGrowl(data);
					jQuery("#allergies_inactive").trigger("reloadGrid");
	...
	$("#save_allergy").click(function(){
		...
		if (bValid) {
			...
			if(str){
				$.ajax({
					type: "POST",
					url: "<?php echo site_url('assistant/chartmenu/edit_allergy');?>",
					data: str,
					dataType: "json",
					success: function(data){
	...
	//Immunization
	$("#imm_load").load('<?php echo site_url("assistant/chartmenu/imm_load");?>');
	...
	$("#alerts_list_dialog").dialog({ 
		...
		open: function(event, ui) {
			...
			jQuery("#alerts").jqGrid({
				url:"<?php echo site_url('assistant/chartmenu/alerts/');?>",
				datatype: "json",
				mtype: "POST",
			...
			jQuery("#alerts_complete").jqGrid({
				url:"<?php echo site_url('assistant/chartmenu/alerts_complete/');?>",
				datatype: "json",
				mtype: "POST",
			...
			jQuery("#alerts_not_complete").jqGrid({
				url:"<?php echo site_url('assistant/chartmenu/alerts_not_complete/');?>",
				datatype: "json",
				mtype: "POST",
	...
	$("#complete_alert").click(function(){
		...
		if(item){
			$.ajax({
				type: "POST",
				url: "<?php echo site_url('assistant/chartmenu/complete_alert');?>",
				data: "alert_id=" + item,
				success: function(data){
					$.jGrowl(data);
	...
	$("#delete_alert").click(function(){
		...
		if(item){
			if(confirm('Are you sure you want to delete this alert?')){
				$.ajax({
					type: "POST",
					url: "<?php echo site_url('assistant/chartmenu/delete_alert');?>",
					data: "alert_id=" + item,
					success: function(data){
						$.jGrowl(data);
						jQuery("#alerts").trigger("reloadGrid");
	...
	$("#save_alert").click(function(){
		...
		if (bValid) {
			...
			if(str){
				$.ajax({
					type: "POST",
					url: "<?php echo site_url('assistant/chartmenu/edit_alert');?>",
					data: str,
					success: function(data){
						$.jGrowl(data);
						jQuery("#alerts").trigger("reloadGrid");
	...
	$("#save_alert1").click(function(){
		...
		if (bValid) {
			...
			if(str){
				$.ajax({
					type: "POST",
					url: "<?php echo site_url('assistant/chartmenu/incomplete_alert');?>",
					data: str,
					success: function(data){
						$.jGrowl(data);
						jQuery("#alerts").trigger("reloadGrid");
	...
	$("#documents_list_dialog").dialog({ 
		...
		open: function() {
			...
			jQuery("#labs").jqGrid({
				url:"<?php echo site_url('assistant/chartmenu/labs/');?>",
				datatype: "json",
				mtype: "POST",
				...
				sortname: 'documents_date',
			 	...
			 	onCellSelect: function(id,iCol) {
					if (iCol > 1) {
				 		...
				 		$.ajax({
							type: "POST",
							url: "<?php echo site_url('assistant/chartmenu/view_documents1');?>/" + id,
							dataType: "json",
							success: function(data){
				...
				onClickButton: function(){ 
					...
					if(id){
						if(confirm('Are you sure you want to delete this document?')){ 
							$.ajax({
								type: "POST",
								url: "<?php echo site_url('assistant/chartmenu/delete_document');?>",
			...
			jQuery("#radiology").jqGrid({
				url:"<?php echo site_url ('assistant/chartmenu/radiology/');?>",
				datatype: "json",
				mtype: "POST",
				colNames:['ID','Date','From','Description','Type','URL'],
				colModel:[
			...
			jQuery("#cardiopulm").jqGrid({
				url:"<?php echo site_url('assistant/chartmenu/cardiopulm/');?>",
				datatype: "json",
				mtype: "POST",
				colNames:['ID','Date','From','Description','Type','URL'],
				colModel:[
			...
			jQuery("#endoscopy").jqGrid({
				url:"<?php echo site_url('assistant/chartmenu/endoscopy/');?>",
				datatype: "json",
				mtype: "POST",
				colNames:['ID','Date','From','Description','Type','URL'],
				colModel:[
			...
			jQuery("#referrals").jqGrid({
				url:"<?php echo site_url('assistant/chartmenu/referrals/');?>",
				datatype: "json",
				mtype: "POST",
				colNames:['ID','Date','From','Description','Type','URL'],
				colModel:[
			...
			jQuery("#past_records").jqGrid({
				url:"<?php echo site_url('assistant/chartmenu/past_records/');?>",
				datatype: "json",
				mtype: "POST",
				colNames:['ID','Date','From','Description','Type','URL'],
				colModel:[
			...
			jQuery("#outside_forms").jqGrid({
				url:"<?php echo site_url('assistant/chartmenu/other_forms/');?>",
				datatype: "json",
				mtype: "POST",
				colNames:['ID','Date','From','Description','Type','URL'],
				colModel:[
			...
			jQuery("#letters").jqGrid({
				url:"<?php echo site_url('assistant/chartmenu/letters/');?>",
				datatype: "json",
				mtype: "POST",
				colNames:['ID','Date','From','Description','Type','URL'],
				colModel:[
	...
	$("#save_document").click(function() {
		...
		window.open("<?php echo site_url('assistant/chartmenu/view_documents');?>/" + id);
	});
	...
	$("#save_menu_documents").click(function() {
		...
		if (bValid) {
			...
			if(str){
				$.ajax({
					type: "POST",
					url: "<?php echo site_url('assistant/chartmenu/edit_document');?>",
					data: str,
					success: function(data){
						$.jGrowl(data);
						$('#documents_edit_form').clearForm();
	...
	$("#prevention_list").click(function() {
		$.ajax({
			type: "POST",
			url: "<?php echo site_url('assistant/chartmenu/prevention');?>",
			success: function(data){
	...
	//Letters
	$("#letter_load").load('<?php echo site_url("assistant/chartmenu/letter_load");?>');
	//Billing
	$("#billing_load").load('<?php echo site_url("assistant/chartmenu/billing_load");?>');
	//Printing
	$("#print_load").load('<?php echo site_url("assistant/chartmenu/print_load");?>');
	$('.nosh_button').button();
	...
	$.ajax({
		...
		success: function(data){
			if (data.response == 'y') {
				...
				$("#mtm_load").load('<?php echo site_url("assistant/chartmenu/mtm_load");?>');
			}
		}
	});
</script>
