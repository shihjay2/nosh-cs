<div id="messages_cp_dialog" title="Cardiopulmonary Helper">
	...
	<div id="messages_cp_edit_fields">
		...
		Provider: <select id ="messages_cp_provider_list" name="encounter_provider" class="text ui-widget-content ui-corner-all"></select>
	...
	$("#messages_cp_save").click(function(){
		...
		if (bValid) {
			...
			$.ajax({
				...
				data: "orders_cp=" + a + "&orders_cp_icd=" + b + "&address_id=" + c + "&t_messages_id=" + d + "&orders_id=" + e + "&orders_insurance=" + f + "&provider=" + g,
				dataType: "json",
				success: function(data){
					$.jGrowl(data.message);
