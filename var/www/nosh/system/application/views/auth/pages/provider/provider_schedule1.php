			...
			'Save': function() { 
				...
				if(str){
					if (visit_type == '' && end == '') {
						...
						$.ajax({
							type: "POST",
							url: "<?php echo site_url('provider/schedule/edit_event/');?>",
							data: str,
	...
	function loadcalendar (y,m,d,view) {
		$('#providers_calendar').fullCalendar({
			...
			events: function(start, end, callback) {
				...
				$.ajax({
					type: "POST",
					url: "<?php echo site_url('provider/schedule/provider_schedule/');?>",
					dataType: 'json',
			...
			eventDrop: function(event,dayDelta,minuteDelta,allDay,revertFunc) {
				...
				if(start){
					$.ajax({
						type: "POST",
						url: "<?php echo site_url('provider/schedule/drag_event/');?>",
