<form id="encounters_labs">
	<div id="labs_ua_tip" style="display:none"></div>
	<div id="labs_rapid_tip" style="display:none"></div>
	<div id="labs_micro_tip" style="display:none"></div>
	<div id="labs_other_tip" style="display:none"></div>
	<table>
		<tr>
			<td valign="top">
				<table>
					<tr>
						<td><div id="button_labs_ua_status"><?php echo $ua_status;?></div></td>
						<td><input type="button" id="button_labs_ua" value="Dipstick UA" class="ui-button ui-state-default ui-corner-all"></td>
					</tr>
					<tr>
						<td><div id="button_labs_rapid_status"><?php echo $rapid_status;?></div></td>
						<td><input type="button" id="button_labs_rapid" value="Rapid Tests" class="ui-button ui-state-default ui-corner-all"></td>
					</tr>
					<tr>
						<td><div id="button_labs_micro_status"><?php echo $micro_status;?></div></td>
						<td><input type="button" id="button_labs_micro" value="Microscopy" class="ui-button ui-state-default ui-corner-all"></td>
					</tr>
					<tr>
						<td><div id="button_labs_other_status"><?php echo $other_status;?></div></td>
...
<div id="labs_ua_dialog" title="Dipstick Urinalysis" style="font-size: 0.9em">
...
<div id="labs_rapid_dialog" title="Rapid Tests" style="font-size: 0.9em">
	...
	<form id="labs_rapid_form">
		<fieldset class="ui-state-default ui-corner-all">
			...
			<table>
				<tr>
					<td align="left">Urine HcG:</td>
					<td align="left">
						<select name="labs_upt" id="labs_upt" class="text ui-widget-content ui-corner-all">
							<option value="">Select One</option>
							<option value="Negative">Negative</option>
							<option value="Positive">Positive</option>
						</select>
...
<div id="labs_micro_dialog" title="Microscopy" style="font-size: 0.9em">
...
<div id="labs_other_dialog" title="Other" style="font-size: 0.9em">
...
<script type="text/javascript">
		...
		beforeclose: function(event, ui) {
			...
			if(a != '' && a != a1 && b != '' && b != b1 && c != '' && c != c1 && d != '' && d != d1 && e != '' && e != e1 && f != '' && f != f1 && g != '' && g != g1 && h != '' && h != h1 && i != '' && i != i1 && j != '' && j != j1 && k != '' && k != k1 && l != '' && l != l1){
				if(confirm('Updates have not been saved.  Are you sure you want to close this window?  If not, press Cancel.')){ 
					$.ajax({
						type: "POST",
						url: "<?php echo site_url('provider/encounters/check_labs');?>",
						dataType: "json",
	...
	$("#button_labs_ua").click(function() {
		$.ajax({
			type: "POST",
			url: "<?php echo site_url('provider/encounters/get_labs');?>",
			dataType: "json",
			success: function(data){
	...
	$('#button_labs_ua_status').bt({
		contentSelector: "$('#labs_ua_tip')",
		width: 600
	});
	$.ajax({
		type: "POST",
		url: "<?php echo site_url('provider/encounters/tip_labs1');?>",
		success: function(data){
			$('#labs_ua_tip').html(data);
		}
	});
	...
	$('#button_labs_rapid_status').bt({
		contentSelector: "$('#labs_rapid_tip')",
		width: 600
	});
	$.ajax({
		type: "POST",
		url: "<?php echo site_url('provider/encounters/tip_labs2');?>",
		success: function(data){
			$('#labs_rapid_tip').html(data);
		}
	});
	...
	$('#button_labs_micro_status').bt({
		contentSelector: "$('#labs_micro_tip')",
		width: 600
	});
	$.ajax({
		type: "POST",
		url: "<?php echo site_url('provider/encounters/tip_labs3');?>",
		success: function(data){
			$('#labs_micro_tip').html(data);
		}
	});
	...
	$('#button_labs_other_status').bt({
		contentSelector: "$('#labs_other_tip')",
		width: 600
	});
	$.ajax({
		type: "POST",
		url: "<?php echo site_url('provider/encounters/tip_labs4');?>",
		success: function(data){
			$('#labs_other_tip').html(data);
		}
	});
	$('#save_labs_ua').click(function(){
		...
		if(str){
			$.ajax({
				type: "POST",
				url: "<?php echo site_url('provider/encounters/labs_save/ua');?>",
				data: str,
				success: function(data){
					$.jGrowl(data);
					$('#labs_ua_urobili').val('');
	...
	$('#save_labs_rapid').click(function(){
		...
		if(str){
			$.ajax({
				type: "POST",
				url: "<?php echo site_url('provider/encounters/labs_save/rapid');?>",
				data: str,
				success: function(data){
					$.jGrowl(data);
					$('#labs_upt').val('');
	...
	$('#save_labs_micro').click(function(){
		...
		if(str){
			$.ajax({
				type: "POST",
				url: "<?php echo site_url('provider/encounters/labs_save/micro');?>",
				data: str,
				success: function(data){
					$.jGrowl(data);
					$('#labs_microscope').val('');
	...
	$('#save_labs_other').click(function(){
		...
		if(str){
			$.ajax({
				type: "POST",
				url: "<?php echo site_url('provider/encounters/labs_save/other');?>",
				data: str,
				success: function(data){
					$.jGrowl(data);
					$('#labs_other').val('');
