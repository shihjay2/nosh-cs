...
<script type="text/javascript">
	$('#add_addendum').button().click(function(){
		window.location = "<?php echo site_url ('provider/encounters/new_addendum/') . '/' . $eid;?>";
	});
	$.ajax({
		type: "POST",
		url: "<?php echo site_url('provider/encounters/previous_versions/') . '/' . $eid;?>",
		success: function(data) {
			...
			$('.addendum_class').click(function(){
				...
				$.ajax({
					type: "POST",
					url: "<?php echo site_url('provider/encounters/get_previous_versions/');?>" + "/" + eid,
					success: function(data) {
