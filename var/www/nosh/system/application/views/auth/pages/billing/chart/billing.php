...
<script type="text/javascript">
	$("#billing_list_dialog").dialog({ 
		...
		open: function(event, ui) {
			...
			jQuery("#billing_encounters").jqGrid({
				url:"<?php echo site_url('billing/chartmenu/billing_encounters/');?>",
				datatype: "json",
				mtype: "POST",
				...
				sortname: 'encounter_DOS',
			 	...
			 	subGridRowExpanded: function(subgrid_id, row_id) {
			 		...
			 		jQuery("#"+subgrid_table_id).jqGrid({
			 			url:"<?php echo site_url('billing/chartmenu/billing_payment_history1');?>/"+row_id,
			 			datatype: "json",
			 			mtype: "POST",
			 			...
			 			onSelectRow: function(id) {
			 				...
			 				$.ajax({
								type: "POST",
								url: "<?php echo site_url('billing/chartmenu/get_payment');?>",
								data: "id=" + id,
								dataType: "json",
						...
						onClickButton: function(){ 
							...
							if(id){
				 				...
				 				if(confirm('Are you sure you want to delete this payment?')){
									$.ajax({
										type: "POST",
										url: "<?php echo site_url('billing/chartmenu/delete_payment1');?>",
										data: "id=" + id,
										dataType: 'json',
										success: function(data){
									...
									$.ajax({
										type: "POST",
										url: "<?php echo site_url('billing/chartmenu/total_balance/');?>",
										success: function(data){
			...
			jQuery("#billing_other").jqGrid({
				url:"<?php echo site_url('billing/chartmenu/billing_other/');?>",
				datatype: "json",
				mtype: "POST",
				...
				sortname: 'dos_f',
			 	...
			 	subGridRowExpanded: function(subgrid_id, row_id) {
			 		...
			 		$("#"+subgrid_id).html("<table id='"+subgrid_table_id+"' class='scroll'></table><div id='"+pager_id+"' class='scroll'></div>");
			 		jQuery("#"+subgrid_table_id).jqGrid({
			 			url:"<?php echo site_url('billing/chartmenu/billing_payment_history2');?>/"+row_id,
			 			datatype: "json",
			 			mtype: "POST",
			 			colNames:['ID','Date of Payment','Payment Amount','Payment Type'],
			 			colModel:[
						...
						onClickButton: function(){ 
							...
							if(id){
				 				...
				 				if(confirm('Are you sure you want to delete this payment?')){
									$.ajax({
										type: "POST",
										url: "<?php echo site_url('billing/chartmenu/delete_payment2');?>",
										data: "id=" + id,
										dataType: 'json',
										success: function(data){
											if (data.message == 'Close Chart') {
	...
	$("#billing_notes").click(function(){
		...
		$.ajax({
			type: "POST",
			url: "<?php echo site_url('billing/chartmenu/get_billing_notes/');?>",
			success: function(data){
	...
	$("#save_billing_notes").click(function(){
		...
		if(str){
			$.ajax({
				type: "POST",
				url: "<?php echo site_url('billing/chartmenu/edit_billing_notes');?>",
				data: str,
				success: function(data){
					if (data == 'Close Chart') {
						window.location = "<?php echo site_url();?>";
	...
	$("#save_billing_payment_form").click(function(){
		...
		if (bValid) {
			...
			if(str){
				$.ajax({
					type: "POST",
					url: "<?php echo site_url('billing/chartmenu/payment_save/');?>",
					data: str,
					dataType: "json",
					success: function(data){
						$.jGrowl(data.message);
	...
	$("#edit_encounter_charge").click(function(){
		...
		if(id){
			$("#billing_eid_1").val(id);
	 		$.ajax({
				type: "POST",
				url: "<?php echo site_url('billing/chartmenu/get_billing1');?>/" + id,
				dataType: "json",
				success: function(data){
			...
			$.ajax({
				type: "POST",
				url: "<?php echo site_url('billing/chartmenu/get_prevention');?>/" + id,
				dataType: "json",
				success: function(data){
			...
			$.ajax({
				type: "POST",
				url: "<?php echo site_url('billing/chartmenu/get_insurance_id1');?>/" + id,
				dataType: "json",
				success: function(data){
	...
	$("#invoice_encounter_charge").click(function(){
		var item = jQuery("#billing_encounters").getGridParam('selrow');
		if(item){
			window.open("<?php echo site_url('billing/chartmenu/print_invoice1');?>/" + item);
		} else {
	...
	$("#invoice_charge").click(function(){
		var item = jQuery("#billing_other").getGridParam('selrow');
		if(item){
			window.open("<?php echo site_url('billing/chartmenu/print_invoice2');?>/" + item);
		} else {
			$.jGrowl("Please select encounter to print invoice!");
		}
	});
	...
	$("#delete_charge").click(function(){
		...
		if(item){
			if(confirm('Are you sure you want to delete this miscellaneous bill?')){
				$.ajax({
					type: "POST",
					url: "<?php echo site_url('billing/chartmenu/delete_other_bill');?>",
	...
	$("#save_other_billing_form").click(function(){
		...
		if (bValid) {
			...
			if(str){
				$.ajax({
					type: "POST",
					url: "<?php echo site_url('billing/chartmenu/billing_other_save/');?>",
					data: str,
					dataType: "json",
					success: function(data){
						$.jGrowl(data.message);
	...
	$("#save_billing1").click(function(){
		...
		$.ajax({
			type: "POST",
			url: "<?php echo site_url('billing/chartmenu/billing_save1');?>",
	...
	$("#print_invoice1").button({icons: {primary: "ui-icon-print"}}).click(function(){
		...
		var ins2 = $("#billing_insurance_id_2").val();
		var eid = $("#billing_eid_1").val();
		window.open("<?php echo site_url('billing/chartmenu/print_invoice1');?>/" + eid + "/" + ins1 + "/" + ins2);
		$.ajax({
			type: "POST",
			url: "<?php echo site_url('billing/chartmenu/total_balance/');?>",
			success: function(data){
	...
	$("#print_hcfa1").button({icons: {primary: "ui-icon-print"}}).click(function(){
		...
		if (bValid) {
			...
			if (ins1 == '' || ins1 == '0') {
				...
				window.open("<?php echo site_url('billing/chartmenu/generate_hcfa1');?>/" + eid + "/" + ins1 + "/" + ins2);
				$.ajax({
					type: "POST",
					url: "<?php echo site_url('billing/chartmenu/total_balance/');?>",
					success: function(data){
			...
			'Save': function() {
				...
				if (bValid) {
					...
					if(str){
						$.ajax({
							type: "POST",
							url: "<?php echo site_url('billing/chartmenu/billing_save');?>/" + eid,
							data: str,
							success: function(data){
								if (data == 'Close Chart') {
									window.location = "<?php echo site_url();?>";
