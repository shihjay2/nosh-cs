<div id="messages_rad_dialog" title="Imaging Helper">
	...
	<div id="messages_rad_edit_fields">
		...
		Provider: <select id ="messages_rad_provider_list" name="encounter_provider" class="text ui-widget-content ui-corner-all"></select>
...
<script type="text/javascript">
	...
	$("#messages_rad_save").click(function(){
		...
		if (bValid) {
			...
			var g = $("#messages_rad_provider_list").val();
			$.ajax({
				type: "POST",
				url: "<?php echo site_url('assistant/chartmenu/add_rad_order');?>",
				data: "orders_radiology=" + a + "&orders_radiology_icd=" + b + "&address_id=" + c + "&t_messages_id=" + d + "&orders_id=" + e + "&orders_insurance=" + f + "&provider=" + g,
				dataType: "json",
				success: function(data){
					$.jGrowl(data.message);
