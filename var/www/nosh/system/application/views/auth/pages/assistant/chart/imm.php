...
<script type="text/javascript">
	$("#immunizations_list_dialog").dialog({ 
		...
		open: function(event, ui) {
			...
			jQuery("#immunizations").jqGrid({
				url:"<?php echo site_url('assistant/chartmenu/immunizations/');?>",
				datatype: "json",
				mtype: "POST",
			...
			$.ajax({
				type: "POST",
				url: "<?php echo site_url('assistant/chartmenu/get_imm_notes/');?>",
	...
	$("#delete_immunization").click(function(){
		...
		if(item){
			if(confirm('Are you sure you want to delete this immunization?')){
				$.ajax({
					type: "POST",
					url: "<?php echo site_url('assistant/chartmenu/delete_immunization');?>",
					data: "imm_id=" + item,
					success: function(data){
						$.jGrowl(data);
	...
	$("#consent_immunization1").click(function(){
		...
		if(item) {
			$.ajax({
				type: "POST",
				url: "<?php echo site_url('assistant/chartmenu/consent_immunizations');?>",
		...
		if (success_doc == true) {
			window.open("<?php echo site_url('assistant/chartmenu/print_consent');?>");
			success_doc = false;
		}
	});
	...
	$("#save_immunization").click(function(){
		...
		if (bValid) {
			...
			if(str){
				$.ajax({
					type: "POST",
					url: "<?php echo site_url('assistant/chartmenu/edit_immunization');?>",
					data: str,
					dataType: "json",
					success: function(data){
	...
	$("#save_immunization1").click(function(){
		...
		if (bValid) {
			...
			if(str){
				$.ajax({
					type: "POST",
					url: "<?php echo site_url('assistant/chartmenu/edit_immunization1');?>",
					data: str,
					dataType: "json",
					success: function(data){
						if (data.message == 'Close Chart') {
	...
	$('#save_orders_imm').click(function(){
		...
		$.ajax({
			type: "POST",
			url: "<?php echo site_url('assistant/encounters/orders_imm_save');?>",
	...
	$("#print_immunizations").click(function() {
		window.open("<?php echo site_url('asssitant/chartmenu/print_immunization_list');?>/");
	});
	...
	$("#print_immunizations1").click(function() {
		window.open("<?php echo site_url('assistant/chartmenu/print_immunization_list');?>/");
	});
	$("#csv_immunizations").button();
	$("#csv_immunizations").click(function() {
		window.location = "<?php echo site_url('assistant/chartmenu/csv_immunization');?>/";
	});
	...
	$("#imm_notes_button").click(function(){
		...
		$.ajax({
			type: "POST",
			url: "<?php echo site_url('assistant/chartmenu/get_imm_notes1/');?>",
			success: function(data){
				$('#imm_notes').val(data);
	...
	$("#save_imm_notes").click(function(){
		...
		if(str){
			$.ajax({
				type: "POST",
				url: "<?php echo site_url('assistant/chartmenu/edit_imm_notes');?>",
				data: str,
				success: function(data){
					if (data == 'Close Chart') {
						window.location = "<?php echo site_url();?>";
