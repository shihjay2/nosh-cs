...
$(document).ready(function() {
	...
	$(document).idleTimeout({
		inactivity: 3600000,
		noconfirm: 10000,
		alive_url: '<?php echo site_url("assistant/billing");?>',
		redirect_url: '<?php echo site_url("start");?>',
		logout_url: '<?php echo site_url("logout");?>',
		sessionAlive: 300000
	});
	jQuery("#submit_list").jqGrid({
		url:"<?php echo site_url('assistant/billing/submit_list/');?>",
		datatype: "json",
		mtype: "POST",
	...
	$("#submit_batch_printimage").click(function(){
		...
		$.ajax({
			type: "POST",
			url: "<?php echo site_url('assistant/billing/add_queue');?>",
			data: "eid=" + eid,
	...
	$("#submit_batch_hcfa").click(function(){
		...
		$.ajax({
			type: "POST",
			url: "<?php echo site_url('assistant/billing/add_queue1');?>",
			data: "eid=" + eid,
			success: function(data){
				$.jGrowl(data);
				$("#billing_eid").val('');
	...
	$("#submit_single_printimage").click(function(){
		var eid = $("#billing_eid").val();
		window.open("<?php echo site_url ('assistant/billing/printimage_single');?>/" + eid);
		$("#billing_eid").val('');
		jQuery("#submit_list").trigger("reloadGrid");
	...
	$("#submit_hcfa").click(function(){
		var eid = $("#billing_eid").val();
		window.open("<?php echo site_url('assistant/billing/generate_hcfa');?>/" + eid);
		$("#billing_eid").val('');
		$('#submit_bill_form_id').hide('fast');
	});
	$("#submit_batch").button({
	...
	$("#submit_batch").click(function(){
		$.ajax({
			type: "POST",
			url: "<?php echo site_url('assistant/billing/check_batch');?>",
			success: function(data){
				if (data == 'OK') {
					window.open("<?php echo site_url ('assistant/billing/printimage_batch');?>");
				} else {
	...
	$("#submit_batch1").click(function(){
		$.ajax({
			type: "POST",
			url: "<?php echo site_url('assistant/billing/check_batch1');?>",
			success: function(data){
				if (data == 'OK') {
					window.location = "<?php echo site_url ('assistant/billing/printhcfa_batch');?>";
				} else {
					$.jGrowl("No bills in the queue to batch print!");
				}
			}
	...
	jQuery("#bills_done").jqGrid({
		url:"<?php echo site_url('assistant/billing/bills_done/');?>",
		datatype: "json",
		mtype: "POST",
		...
		sortname: 'encounter_DOS',
	 	...
	 	subGridRowExpanded: function(subgrid_id, row_id) {
	 		...
	 		jQuery("#"+subgrid_table_id).jqGrid({
	 			url:"<?php echo site_url('assistant/billing/billing_payment_history1');?>/"+row_id,
	 			datatype: "json",
	 			mtype: "POST",
	 			...
	 			onSelectRow: function(id) {
	 				...
	 				$.ajax({
						type: "POST",
						url: "<?php echo site_url('assistant/billing/get_payment');?>",
						data: "id=" + id,
						dataType: "json",
						success: function(data){
				...
				onClickButton: function(){ 
					...
					if(id){
		 				...
		 				if(confirm('Are you sure you want to delete this payment?')){
							$.ajax({
								type: "POST",
								url: "<?php echo site_url('assistant/billing/delete_payment1');?>",
								data: "id=" + id,
								dataType: 'json',
								success: function(data){
							...
							$.ajax({
								type: "POST",
								url: "<?php echo site_url('assistant/billing/total_balance/');?>",
								success: function(data){
	...
	$("#bill_resubmit").click(function(){
		...
		$.ajax({
			type: "POST",
			url: "<?php echo site_url('assistant/billing/bill_resubmit');?>",
			data: "eid=" + eid,
			success: function(data){
				$.jGrowl(data);
				jQuery("#bills_done").trigger("reloadGrid");
	...
	$("#edit_encounter_charge").click(function(){
		...
		if(id){
			$("#billing_eid_1").val(id);
	 		$.ajax({
				type: "POST",
				url: "<?php echo site_url('assistant/billing/get_billing1');?>/" + id,
				dataType: "json",
				success: function(data){
			...
			$.ajax({
				type: "POST",
				url: "<?php echo site_url('assistant/billing/get_prevention');?>/" + id,
				dataType: "json",
				success: function(data){
			...
			$.ajax({
				type: "POST",
				url: "<?php echo site_url('assistant/billing/get_insurance_id1');?>/" + id,
				dataType: "json",
				success: function(data){
					...
					$.ajax({
						type: "POST",
						url: "<?php echo site_url('assistant/encounters/get_insurance_info');?>",
			...
			$.ajax({
				type: "POST",
				url: "<?php echo site_url('assistant/billing/get_assessment');?>/" + id,
				dataType: "json",
				success: function(data){
					if (data != '') {
			...
			jQuery("#billing_cpt_list").jqGrid({
				url:"<?php echo site_url('assistant/chartmenu/procedure_codes1');?>/" + id,
				datatype: "json",
				mtype: "POST",
				...
				sortname: 'cpt_charge',
			 	...
			 	ondblClickRow: function(id){
					...
					$.ajax({
						type: "POST",
						url: "<?php echo site_url('assistant/chartmenu/define_icd');?>/" + id,
						data: "icd=" + item,
						dataType: "json",
						success: function(data){
	...
	$("#payment_encounter_charge1").click(function(){
		...
		if(item){
			...
			$.ajax({
				type: "POST",
				url: "<?php echo site_url('assistant/billing/set_billing_id1');?>/" + item,
				success: function(data){
					if (data == "Set!") {
	...
	jQuery("#outstanding_balance").jqGrid({
		url:"<?php echo site_url('assistant/billing/outstanding_balance/');?>",
		datatype: "json",
		mtype: "POST",
		...
		sortname: 'lastname',
	 	...
	 	onSelectRow: function(id) {
	 		$.ajax({
				type: "POST",
				url: "<?php echo site_url('assistant/billing/set_billing_id');?>/" + id,
				success: function(data){
					if (data == "Set!") {
						$.ajax({
							type: "POST",
						...
						jQuery("#billing_encounters").jqGrid({
							url:"<?php echo site_url('assistant/billing/billing_encounters/');?>",
							datatype: "json",
							mtype: "POST",
						...
						jQuery("#billing_other").jqGrid({
							url:"<?php echo site_url('assistant/billing/billing_other/');?>",
							datatype: "json",
							mtype: "POST",
							...
							sortname: 'dos_f',
						 	...
						 	subGridRowExpanded: function(subgrid_id, row_id) {
						 		...
						 		$("#"+subgrid_id).html("<table id='"+subgrid_table_id+"' class='scroll'></table><div id='"+pager_id+"' class='scroll'></div>");
						 		jQuery("#"+subgrid_table_id).jqGrid({
						 			url:"<?php echo site_url('assistant/billing/billing_payment_history2');?>/"+row_id,
						 			datatype: "json",
						 			mtype: "POST",
						 			colNames:['ID','Date of Payment','Payment Amount','Payment Type'],
						 			colModel:[
									...
									onClickButton: function(){ 
										...
										if(id){
							 				...
							 				if(confirm('Are you sure you want to delete this payment?')){
												$.ajax({
													type: "POST",
													url: "<?php echo site_url('assistant/billing/delete_payment2');?>",
													data: "id=" + id,
													dataType: 'json',
													success: function(data){
														if (data.message == 'Close Chart') {
						...
						jQuery("#billing_insurance_list1").jqGrid({
							url:"<?php echo site_url('assistant/billing/insurance/');?>",
							datatype: "json",
							mtype: "POST",
	...
	$("#billing_detail_dialog").dialog({ 
		...
		close: function(event, ui) {
			...
			if (b != '') {
				...
				$.ajax({
					type: "POST",
					url: "<?php echo site_url('assistant/encounters/get_cpt_charge');?>",
					data: "cpt=" + b,
					success: function(data){
	...
	$("#billing_notes").click(function(){
		...
		$.ajax({
			type: "POST",
			url: "<?php echo site_url('assistant/billing/get_billing_notes/');?>",
			success: function(data){
	...
	$("#save_billing_notes").click(function(){
		...
		if(str){
			$.ajax({
				type: "POST",
				url: "<?php echo site_url('assistant/billing/edit_billing_notes');?>",
				data: str,
				success: function(data){
					if (data == 'Close Chart') {
						window.location = "<?php echo site_url();?>";
	...
	$("#save_billing_payment_form").click(function(){
		...
		if (bValid) {
			...
			if(str){
				$.ajax({
					type: "POST",
					url: "<?php echo site_url('assistant/billing/payment_save/');?>",
					data: str,
					dataType: "json",
					success: function(data){
						$.jGrowl(data.message);
	...
	$("#invoice_encounter_charge").click(function(){
		var item = jQuery("#billing_encounters").getGridParam('selrow');
		if(item){
			window.open("<?php echo site_url('assistant/billing/print_invoice1');?>/" + item);
		} else {
	...
	$("#invoice_charge").click(function(){
		var item = jQuery("#billing_other").getGridParam('selrow');
		if(item){
			window.open("<?php echo site_url('assistant/billing/print_invoice2');?>/" + item);
		} else {
			$.jGrowl("Please select encounter to print invoice!");
		}
	});
	...
	$("#delete_charge").click(function(){
		...
		if(item){
			if(confirm('Are you sure you want to delete this miscellaneous bill?')){
				$.ajax({
					type: "POST",
					url: "<?php echo site_url('assistant/billing/delete_other_bill');?>",
	...
	$("#save_other_billing_form").click(function(){
		...
		if (bValid) {
			...
			if(str){
				$.ajax({
					type: "POST",
					url: "<?php echo site_url('assistant/billing/billing_other_save/');?>",
					data: str,
					dataType: "json",
					success: function(data){
						$.jGrowl(data.message);
	...
	$("#save_billing1").click(function(){
		...
		$.ajax({
			type: "POST",
			url: "<?php echo site_url('assistant/billing/billing_save1');?>",
	...
	$("#print_invoice1").button({icons: {primary: "ui-icon-print"}}).click(function(){
		...
		var ins2 = $("#billing_insurance_id_2").val();
		var eid = $("#billing_eid_1").val();
		window.open("<?php echo site_url('assistant/billing/print_invoice1');?>/" + eid + "/" + ins1 + "/" + ins2);
		$.ajax({
			type: "POST",
			url: "<?php echo site_url('assistant/billing/total_balance/');?>",
			success: function(data){
	...
	$("#print_hcfa1").button({icons: {primary: "ui-icon-print"}}).click(function(){
		...
		if (bValid) {
			...
			if (ins1 == '' || ins1 == '0') {
				...
				window.open("<?php echo site_url('assistant/billing/generate_hcfa1');?>/" + eid + "/" + ins1 + "/" + ins2);
				$.ajax({
					type: "POST",
					url: "<?php echo site_url('assistant/billing/total_balance/');?>",
					success: function(data){
	...
	$("#remove_billing_cpt1").click(function(){
		...
		if(item){
			$.ajax({
				url: "<?php echo site_url('assistant/encounters/remove_cpt');?>",
				type: "POST",
				data: "billing_core_id=" + item,
				success: function(data){
					$.jGrowl(data);
			...
			'Save': function() {
				...
				if (bValid) {
					...
					if(str){
						$.ajax({
							type: "POST",
							url: "<?php echo site_url('assistant/billing/billing_save');?>/" + eid,
							data: str,
							success: function(data){
								if (data == 'Close Chart') {
									window.location = "<?php echo site_url();?>";
	...
	$('#update_cpt_charge1').click(function(){
		...
		if(item != ''){
			...
			$.ajax({
				url: "<?php echo site_url('assistant/encounters/update_cpt_charge');?>",
				type: "POST",
	...
	jQuery("#monthly_stats").jqGrid({
		url:"<?php echo site_url('assistant/billing/monthly_stats/');?>",
		datatype: "json",
		mtype: "POST",
		...
		sortname: 'month',
	 	...
	 	subGridRowExpanded: function(subgrid_id, row_id) {
	 		...
	 		$("#"+subgrid_id).html("<table id='"+subgrid_table_id+"' class='scroll'></table><div id='"+pager_id+"' class='scroll'></div>");
	 		jQuery("#"+subgrid_table_id).jqGrid({
	 			url:"<?php echo site_url('assistant/billing/monthly_stats_insurance');?>/"+row_id,
	 			datatype: "json",
	 			mtype: "POST",
	...
	jQuery("#yearly_stats").jqGrid({
		url:"<?php echo site_url('assistant/billing/yearly_stats/');?>",
		datatype: "json",
		mtype: "POST",
		...
		sortname: 'year',
	 	...
	 	subGridRowExpanded: function(subgrid_id, row_id) {
	 		...
	 		$("#"+subgrid_id).html("<table id='"+subgrid_table_id+"' class='scroll'></table><div id='"+pager_id+"' class='scroll'></div>");
	 		jQuery("#"+subgrid_table_id).jqGrid({
	 			url:"<?php echo site_url('assistant/billing/yearly_stats_insurance');?>/"+row_id,
	 			datatype: "json",
	 			mtype: "POST",
	 			colNames:['Insurance','Patients Seen'],
	 			colModel:[
	...
	$("#demographics_insurance_dialog").dialog({ 
		...
		open: function(event, ui) {
			...
			jQuery("#demographics_insurance").jqGrid({
				url:"<?php echo site_url('assistant/billing/insurance_active/');?>",
				datatype: "json",
				mtype: "POST",
				colNames:['ID','Insurance','ID Number','Group Number','Priority','Lastname','Firstname','DOB','Gender','Address','City','State','Zip','Copay','Deductible','Comments','Address ID','Relationship'],
				colModel:[
			...
			jQuery("#demographics_insurance_inactive").jqGrid({
				url:"<?php echo site_url('assistant/billing/insurance_inactive/');?>",
				datatype: "json",
				mtype: "POST",
				colNames:['ID','Insurance','ID Number','Group Number','Priority','Lastname','Firstname','DOB','Gender','Address','City','State','Zip','Copay','Deductible','Comments','Address ID','Relationship'],
				colModel:[
	...
	$("#demographics_inactivate_insurance").click(function(){
		...
		if(item){
			$.ajax({
				type: "POST",
				url: "<?php echo site_url('assistant/billing/inactivate_insurance');?>",
	...
	$("#demographics_delete_insurance").click(function(){
		...
		if(item){
			if(confirm('Are you sure you want to delete this insurance?  This is not recommended unless entering the insurance was a mistake!')){ 
				$.ajax({
					type: "POST",
					url: "<?php echo site_url('assistant/billing/delete_insurance');?>",
					data: "insurance_id=" + item,
					success: function(data){
						if (data == 'Close Chart') {
							window.location = "<?php echo site_url();?>";
	...
	$("#demographics_reactivate_insurance").click(function(){
		...
		if(item){
			$.ajax({
				type: "POST",
				url: "<?php echo site_url('assistant/billing/reactivate_insurance');?>",
				data: "insurance_id=" + item,
				success: function(data){
					if (data == 'Close Chart') {
						window.location = "<?php echo site_url();?>";
	...
	$("#menu_insurance_relationship").change(function(){
		if($("#menu_insurance_relationship").val() == "Self") {
			$.ajax({
				type: "POST",
				url: "<?php echo site_url('assistant/billing/copy_address');?>",
				dataType: "json",
				success: function(data){
	...
	$("#menu_add_insurance_plan").click(function(){
		...
		if (bValid) {
			...
			if(str){
				$.ajax({
					type: "POST",
					url: "<?php echo site_url('assistant/billing/edit_insurance_provider');?>",
					data: str,
					dataType: "json",
					success: function(data){
						$.jGrowl(data.message);
	...
	$("#save_menu_insurance").click(function(){
		...
		if (bValid) {
			...
			if(str){
				$.ajax({
					type: "POST",
					url: "<?php echo site_url('assistant/billing/edit_insurance');?>",
					data: str,
					success: function(data){
						if (data == 'Close Chart') {
							window.location = "<?php echo site_url();?>";
