	...
	<div id="pe_gu_accordion">
		...
		<div>
			...
			<div style="display:block;float:left">
				...
				<div class="pe_template_div">
					<br><form id="pe_gu1_form" class="pe_template_form ui-widget"></form>
				</div>
			</div>
		</div>
		...
		<div>
			...
			<div style="display:block;float:left">
				...
				<div class="pe_template_div">
					<br><form id="pe_gu2_form" class="pe_template_form ui-widget"></form>
				</div>
			</div>
		</div>
		...
		<div>
			...
			<div style="display:block;float:left">
				...
				<div class="pe_template_div">
					<br><form id="pe_gu3_form" class="pe_template_form ui-widget"></form>
				</div>
			</div>
		</div>
		...
		<div>
			...
			<div style="display:block;float:left">
				...
				<div class="pe_template_div">
					<br><form id="pe_gu4_form" class="pe_template_form ui-widget"></form>
				</div>
			</div>
		</div>
		...
		<div>
			...
			<div style="display:block;float:left">
				...
				<div class="pe_template_div">
					<br><form id="pe_gu5_form" class="pe_template_form ui-widget"></form>
				</div>
			</div>
		</div>
		...
		<div>
			...
			<div style="display:block;float:left">
				...
				<div class="pe_template_div">
					<br><form id="pe_gu6_form" class="pe_template_form ui-widget"></form>
				</div>
			</div>
		</div>
	</div>
...
<script type="text/javascript">
	...
	$('#save_pe_gu').click(function(){
		...
		$.ajax({
			...
			data: "pe_gu1=" + a + "&pe_gu2=" + b + "&pe_gu3=" + c + "&pe_gu4=" + d + "&pe_gu5=" + e + "&pe_gu6=" + f + "&pe_gu7=&pe_gu8=&pe_gu9=",
			success: function(data){
				$.jGrowl(data);
				$('#pe_gu1').val('');
				$('#pe_gu1_old').val('');
