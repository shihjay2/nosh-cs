...
<script type="text/javascript">
	...
	jQuery("#supplements").jqGrid({
		url:"<?php echo site_url('provider/chartmenu/supplements/');?>",
		datatype: "json",
		mtype: "POST",
	...
	jQuery("#supplements_inactive").jqGrid({
		url:"<?php echo site_url('provider/chartmenu/supplements_inactive/');?>",
		datatype: "json",
		mtype: "POST",
		colNames:['ID','Date Active','Supplement','Dosage','Unit','SIG','Route','Frequency','Special Instructions','Reason',"Supplement ID"],
		colModel:[
	...
	$("#inactivate_sup").click(function(){
		...
		if(item){
			$.ajax({
				type: "POST",
				url: "<?php echo site_url('provider/chartmenu/inactivate_supplement');?>",
				data: "sup_id=" + item,
				dataType: "json",
				success: function(data){
					$.jGrowl(data.message);
	...
	$("#delete_sup").click(function(){
		...
		if(item){
			if(confirm('Are you sure you want to delete this supplement?  This is not recommended unless entering the supplement was a mistake!')){ 
				$.ajax({
					type: "POST",
					url: "<?php echo site_url('provider/chartmenu/delete_supplement');?>",
					data: "sup_id=" + item,
					success: function(data){
						$.jGrowl(data);
						jQuery("#supplements").trigger("reloadGrid");
	...
	$("#reactivate_sup").click(function(){
		...
		if(item){
			$.ajax({
				type: "POST",
				url: "<?php echo site_url('provider/chartmenu/reactivate_supplement');?>",
				data: "sup_id=" + item,
				dataType: "json",
				success: function(data){
					$.jGrowl(data.message);
	...
	$("#purchase_supplement").click(function(){
		...
		if (bValid) {
			...
			if(a) {
				$.ajax({
					type: "POST",
					url: "<?php echo site_url('provider/chartmenu/check_supplement_inventory');?>",
	...
	$("#save_supplement").click(function(){
		...
		if (bValid) {
			...
			if(str){
				$.ajax({
					type: "POST",
					url: "<?php echo site_url('provider/chartmenu/edit_supplement');?>" + "/N",
					data: str,
					dataType: "json",
					success: function(data){
	...
	$('#save_orders_supplements').click(function(){
		...
		$.ajax({
			type: "POST",
			url: "<?php echo site_url('provider/encounters/orders_sup_save');?>",
	...
	$('#save_oh_supplements').click(function(){
		$.ajax({
			type: "POST",
			url: "<?php echo site_url('provider/encounters/oh_save1/supplements');?>",
			success: function(data){
				$.jGrowl(data);
				$("#supplement_origin_orders").val('');
			...
			'Save': function() {
				...
				if (bValid) {
					...
					if(str){
						...
						$.ajax({
							type: "POST",
							url: "<?php echo site_url('provider/chartmenu/edit_supplement');?>" + "/" + c,
							data: str,
							dataType: "json",
							success: function(data){
								if (data.message == 'Close Chart') {
