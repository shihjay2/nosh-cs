<script type="text/javascript">
			...
			'Save': function() { 
				...
				if(str){
					if (visit_type == '' && end == '') {
						...
						$.ajax({
							type: "POST",
							url: "<?php echo site_url('billing/schedule/edit_event/');?>",
							data: str,
	...
	$('#delete_event').click(function() {
		if(confirm('Are you sure you want to delete this appointment?')){ 
			...
			$.ajax({
				type: "POST",
				url: "<?php echo site_url('billing/schedule/delete_event/');?>",
	...
	function loadcalendar (y,m,d,view) {
		$('#providers_calendar').fullCalendar({
			...
			events: function(start, end, callback) {
				...
				$.ajax({
					type: "POST",
					url: "<?php echo site_url('billing/schedule/provider_schedule/');?>",
					dataType: 'json',
			...
			eventDrop: function(event,dayDelta,minuteDelta,allDay,revertFunc) {
				...
				if(start){
					$.ajax({
						type: "POST",
						url: "<?php echo site_url('billing/schedule/drag_event/');?>",
